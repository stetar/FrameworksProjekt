...
namespace FrameworksProjekt.Builder
{
    class HeadQuartersBuilder : ILBuilder
    {
        ...
        {
            l = new InsideLevel("Headquarters", new Vector2(350, 500), new Tuple<int, int>(240, -100), new Vector2(260, 550), new OutsideLevel("Grenaa", new Vector2(20, 500), new Tuple<int, int>(-120, -120), City.Grenaa, new Vector2(50, 500)));
