...
namespace FrameworksProjekt.Builder
{
    class VeganStoreBuilder : ILBuilder
    {
        ...
        {
            l = new InsideLevel("Vegan store", new Vector2(0, 500), new Tuple<int, int>(400, 100), new Vector2(50, 550), new OutsideLevel("København", new Vector2(20, 500), new Tuple<int, int>(-120, -120), City.København, new Vector2(50, 500)));
